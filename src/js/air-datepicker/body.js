...
(function () {
  var templates = {
      days: '' +
        ...
        '<div class="datepicker__cells datepicker__cells-days"></div>' +
        '</div>',
      months: '' +
        '<div class="datepicker__months datepicker__body">' +
        '<div class="datepicker__cells datepicker__cells-months"></div>' +
        '</div>',
      years: '' +
        '<div class="datepicker__years datepicker__body">' +
        '<div class="datepicker__cells datepicker__cells-years"></div>' +
        '</div>'
    },
  ...
  datepicker.Body.prototype = {
    ...
    _getDayNamesHtml: function (firstDay, curDay, html, i) {
      ...
      html += '<div class="datepicker__day-name' + (this.d.isWeekend(curDay) ? " -weekend-" : "") + '"><h3>' + this.d.loc.daysMin[curDay] + '</h3></div>';

      return this._getDayNamesHtml(firstDay, ++curDay, html, ++i);
    },

    _getCellContents: function (date, type) {
      var classes = "datepicker__cell datepicker__cell-" + type,
