;(function () {
    var template = '' +
        '<div class="datepicker__nav-action" data-action="prev">#{prevHtml}</div>' +
        '<div class="datepicker__nav-title">#{title}</div>' +
        '<div class="datepicker__nav-action" data-action="next">#{nextHtml}</div>',
        buttonsContainerTemplate = '<div class="datepicker__buttons"></div>',
        button = '<button class="datepicker__button" data-action="#{action}">#{label}</button>',
    ...
    datepicker.Navigation.prototype = {
        ...
        _render: function () {
            ...
            if (this.d.view == 'years') {
                $('.datepicker__nav-title', this.d.$nav).addClass('-disabled-');
            }
            this.setNavStatus();
        },
